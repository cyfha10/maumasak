        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-custom">
              ...
              <?php $official_favorite_id = $this->uri->segment(4); ?>
              <form action="<?php echo base_url('recipe_sale/update_official/'.$recipe_id.'/'.$official_favorite_id); ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <a href="<?php echo base_url('recipe_sale/choose_official/'.$recipe_id.'/'.$official_favorite_id) ?>">
