                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    <tr>
                      ...
                      <td width="10%">
                        <a href="<?php echo base_url('recipe_sale/editchoice/'.$choice['source_id'].'/'.$choice['editor_choice_id']); ?>">
                          <button class="btn btn-custom"><i class="fa fa-edit"></i></button>
                        </a>
                        <a href="<?php echo base_url('recipe_sale/deletechoice/'.$choice['editor_choice_id']); ?>">
