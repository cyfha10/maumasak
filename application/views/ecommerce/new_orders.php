                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  foreach ($list_orders as $orders) {?>
                    <tr>
                      ...
                      <td width="10%"><?php echo $orders['order_id'].'<br>'.$orders['invoice_no'].'<hr>Buyer : '.$orders['buyer_name'].'<br> Seller : '.$orders['seller_name']; ?></td>
                      <td width="30%">
                      ...
                      <td width="20%"><?php echo $orders['courier_name'].' ('.$orders['courier_service'].')'.'<br>'.'Rp. '.number_format($orders['shipping_amount'],0,',','.').'<br>'.'PIC : '.$orders['receiver_name']; ?></td>
