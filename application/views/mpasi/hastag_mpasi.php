  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Checklist Tag MPasi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="<?php echo base_url('mpasi/actindexing_mpasi/') ?>" method = "post">
                  <div class="col-md-6">
                    ...
                    <input type="hidden" name="mpasi_id" value="<?php echo $row->mpasi_id; ?>">
                  </div>
                  <br>
