  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Detail Resep Mpasi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
              <li class="breadcrumb-item active">Detail Resep Mpasi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-custom">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                     ...
                     <!-- INI DETAIL RESEP -->
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <br>
                            <img src="https://filestocks.maumasak.id/mpasi/<?php echo $row->customer_id.'/'.$row->cover_image; ?>" width = "20%">
                            <br>
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            ?>
                                  ...
                                  <div class="col-md-12">
                                    <img src="<?php echo $itemzzzz['img_fulluri']; ?>" width = "20%">
                                  </div>
                                  <div class="col-md-12">
                                    &nbsp;
                                  </div>
                          ...
                          <div class="timeline">
                            ...
                            <div>
                              ...
                              <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                  <a href="<?php echo base_url('admin/deletecomment/').$comment['mpasi_comment_id']; ?>"> 
                                ...
                                <?php
                                      $mpasi_id = $row->mpasi_id;
                                      $comment_id = $comment['mpasi_comment_id'];

                                      $query = $this->db->query("SELECT * FROM m_mpasi_comment INNER JOIN m_customer ON m_mpasi_comment.customer_id = m_customer.customer_id WHERE mpasi_id = $mpasi_id AND parent_comment_id = '$comment_id'");
                                      $data = $query->result();
                                      ...
                                      <div class="timeline">
                                        ...
                                        <div>
                                          ...
                                          <div class="timeline-item">
                                              ...
                                              <div class="timeline-footer">
                                                <a href="<?php echo base_url('admin/deletecomment/').$utama->mpasi_comment_id; ?>"> 
                                                    <button class="btn btn-custom btn-sm"><i class="fa fa-trash"></i> Hapus</button>
                                                </a>
                                              </div>
                                            </div>
                            ...
                            <?php $i = 1; foreach ($row_trycook as $trycook) {?>
                              <div>
                                ...
                                <div class="timeline-item">
                                  ...
                                  <div class="timeline-body">
                                    <img src="http://filestocks.maumasak.id/mpasi/trycook/<?php echo $trycook['customer_id'].'/'.$trycook['trycook_image']; ?>" width = "20%">
                                  </div>
                                  <div class="timeline-body">
                                    <a href="<?php echo base_url('mpasi/delete_mpasitrycook/').$trycook['mpasi_trycook_id']; ?>"> 
                                        <button class="btn btn-custom btn-sm"><i class="fa fa-trash"></i> Hapus Trycook</button>
                                    </a>
                                  </div>
                                  <div class="timeline-footer">
                                  <?php
                                      $mpasi_trycook_id = $trycook['mpasi_trycook_id'];
                                      $query_trycomment = $this->db->query("SELECT * FROM m_mpasi_trycook_comment INNER JOIN m_customer ON m_mpasi_trycook_comment.customer_id = m_customer.customer_id WHERE m_mpasi_trycook_comment.mpasi_trycook_id = $mpasi_trycook_id");
                                      ...
                                      <div class="timeline">
                                        ...
                                        <div>
                                          ...
                                          <div class="timeline-item">
                                              ...
                                              <div class="timeline-footer">
                                                <a href="<?php echo base_url('mpasi/deletetry_comment/').$comment_try->mpasi_trycook_comment_id; ?>"> 
                                                    <button class="btn btn-custom btn-sm"><i class="fa fa-trash"></i> Hapus</button>
                                                </a>
                                              </div>
                                          </div>
                  ...
                  <a href="<?php echo base_url('mpasi/approvalmpasi') ?>">
                  ...
                  <?php 
                    ...
                    if ($status_resep == 5) {
                  ?>
                      <a href="<?php echo base_url('mpasi/approval/approved/'.$row->customer_id.'/'.$row->mpasi_id) ?>">
                          <button type="button" class="btn btn-success"><i class="fa fa-check"> </i> Approved</button>
                      </a>

                          <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#revision<?php echo $row->mpasi_id; ?>"><i class="fa fa-random"> </i> Need Revision</button>

                      <a href="<?php echo base_url('mpasi/approval/rejected/'.$row->mpasi_id) ?>">
...
<!-- Modal -->
    <div class="modal fade" id="revision<?php echo $row->mpasi_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url('admin/approval/revision/'.$row->mpasi_id) ?>">
              <div class="modal-body">
                
                    <input type="" name="catatan" class="form-control" placeholder="Masukkan catatan revisinya..">
      ...
      <div class="modal fade" id="editcover" role="dialog">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('mpasi/updatecover/'.$mpasi_id) ?>" method="POST" enctype="multipart/form-data">
              <img src="https://filestocks.maumasak.id/mpasi/<?php echo $row->customer_id.'/'.$row->cover_image; ?>" width = "50%">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-custom">Update Cover</button>
