      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <form action="<?php echo base_url('mpasi/actrecipes_mpasi') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="bs-stepper-header" role="tablist">
                  ...
                  <div class="step" data-target="#addresep-part">
                    <button type="button" class="step-trigger" role="tab" aria-controls="addresep-part" id="addresep-part-trigger">
                      ...
                      <span class="bs-stepper-label">Data Resep MPasi</span>
                    </button>
                  </div>
                  <div class="line"></div>
                ...
                <div class="bs-stepper-content">
                  ...
                  <div id="addresep-part" class="content" role="tabpanel" aria-labelledby="addresep-part-trigger">
                    <div class="form-group">
                      ...
                      <input type="text" name="customer" class="form-control" id="nama" value="<?php echo $customer->fullname; ?>" readonly>
                        <a href="<?php echo base_url('mpasi/gantipelanggan/') ?>">
                          <button type="button" class="btn btn-custom">Ganti</button>
                        </a>
                      <input type="hidden" name="customer_id" value="<?php echo $customer->customer_id; ?>">
                    </div>
                    <div class="form-group">
                      <label for="nama">Nama Resep MPasi</label>
                      <input type="text" name="nama_resep" class="form-control" id="nama" placeholder="Masukkan Nama Resep MPasi" maxlength="50" required>
                    </div>

                    <div class="form-group">
                      <label for="nama">Deskripsi</label>
                      <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Deskripsi" name="deskripsiresep" rows="8" maxlength="4000"></textarea>
                    </div>


                    <div class="form-group">
                      <label for="nama">Kategori MPasi</label>
                      <select name="kategori" id="kategori" class="form-control" required>
                        <option value=""><i>- Pilih Kategori MPasi -</i></option>
                        <?php
                        if($datakategorimpasi){
                          foreach($datakategorimpasi as $kategori){
                            ?>
                            <option value="<?php echo $kategori['category_mpasi_id'];?>"><?php echo $kategori['category_name']; ?></option>
                            <?php
                          }
                        }
                        ?>
                      ...
                      <select name="recipe_status" id="recipe_status" class="form-control" required>
                        ...
                        if($datarecipestatus){
                          foreach($datarecipestatus as $statuss){
                            ?>
                            <option value="<?php echo $statuss['recipe_status_id'];?>"><?php echo $statuss['recipe_status']; ?></option>
                            <?php
                          }
                        }
                        ?>
                  ...
                  <div id="porsi-part" class="content" role="tabpanel" aria-labelledby="porsi-part-trigger">
                    <div class="form-group">
                      ...
                      <input type="number" name="porsi" class="form-control" onkeypress="return hanyaAngka(event)" min="1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="number" name="waktupersiapanbahan" min="0" max="180" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="number" name="waktupersiapanmasak" min="0" max="180" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="radio" name="difficult" value="MUDAH" required> MUDAH
                          <input type="radio" name="difficult" value="SEDANG"> SEDANG
                          <input type="radio" name="difficult" value="SULIT"> SULIT
                        </div>
                      </div>
                    </div>
                  ...
                  <div id="langkah-part" class="content" role="tabpanel" aria-labelledby="langkah-part-trigger">
                    <div id="fieldWrapperz">
                      <div class="field_wrapperz">
                        <div class="form-group">
                          <label>File Step Resep MPasi</label>
                    ...
                    <hr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4" align="right">
                          ...
                          <input type="submit" name="" class="btn btn-success" value="Submit"><!-- <i class="fa fa-check"></i> --> 
                        </div>
                      </div>
...
append+= '    <label>File Step Resep MPasi</label>'
