    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="timeline">
        ...
        if($recipe_trycook){
          ...
          foreach ($recipe_trycook as $trycook) { ?>
            ...
            <div class="post">
              <div class="user-block">
                <img class="img-circle img-bordered-sm" src="https://filestocks.maumasak.id/recipes/trycook/<?php echo $trycook['customer_id'].'/'.$trycook['trycook_image']; ?>" width = "90%">
                <span class="username">
      ...
      <div class="tab-pane" id="komentar">
        ...
        if($recipe_comment){
          ...
          <div class="post">
            <div class="user-block">
              <img class="img-circle img-bordered-sm" src="https://filestocks.maumasak.id/recipes/<?php echo $comment['customer_id'].'/'.$comment['cover_image']; ?>" width = "90%">
              <span class="username">
      ...
      <div class="tab-pane" id="like">
        ...
        if($recipe_like){
          ...
          <div class="post">
            <div class="user-block">
              <img class="img-circle img-bordered-sm" src="https://filestocks.maumasak.id/recipes/<?php echo $like['customer_id'].'/'.$like['cover_image']; ?>" width = "90%">
              <span class="username">
      ...
      <div class="tab-pane" id="order">
        ...
        if($list_orders){
          ...
          <div class="post">
            <div class="user-block">
              <img class="img-circle img-bordered-sm" src="https://filestocks.maumasak.id/recipes/<?php echo $order['customer_id'].'/'.$order['cover_image']; ?>" width = "90%">
              <span class="username">
