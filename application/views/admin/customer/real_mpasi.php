        ...
        <div class="row">
            ...
            <div class="card card-custom card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Mpasi</b> <a class="float-right"><?php echo $mpasi_count; ?></a>
                  </li>
          ...
          <div class="col-md-9">
            <?php $id = $this->uri->segment(3); ?>
              <a href="<?php echo base_url('admin/customerdetail_real/'.$id) ?>">
                <button class="btn btn-danger">Back</button>
              </a>
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Mpasi</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Trycook Mpasi</a></li>
                  <li class="nav-item"><a class="nav-link" href="#komentar" data-toggle="tab">Komentar Mpasi</a></li>
                  <li class="nav-item"><a class="nav-link" href="#like" data-toggle="tab">Like Save Share</a></li>
                  <li class="nav-item"><a class="nav-link" href="#order" data-toggle="tab">Order</a></li>
                  <li class="nav-item"><a class="nav-link" href="#rating" data-toggle="tab">Ulasan</a></li>
                </ul>
              </div><!-- /.card-header -->
              <!-- RECIPE -->

              <?php include "cust_real_mpasi.php"; ?>
