                ...
                <div class="row mt-6">
                  <div class="col-sm-6">
                    <div class="position-relative">
                      ...
                      <a href="<?php echo base_url('admin/real_recipe/'.$id) ?>">
                        <img src="<?php echo base_url('assets/img/photo2.png'); ?>" alt="Photo 1" class="img-fluid">
                  ...
                  <div class="col-sm-6">
                    <div class="position-relative">
                      <a href="<?php echo base_url('admin/real_mpasi/'.$id) ?>">
                        <img src="<?php echo base_url('assets/img/photo3.jpg'); ?>" alt="Photo 2" class="img-fluid">
