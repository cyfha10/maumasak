              ...
              <form action="<?php echo base_url('admin/actbanner/'); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="judul_banner" class="form-control" id="nama" placeholder="Masukkan Nama Cuisine" required>
                  </div>
                  
                  <div class="form-group">
                    <label for="files">Banner Image</label>
                  ...
                  <div class="form-group">
                    <label for="files">Banner Type</label>
                    <div class="input-group">
                      <select class="form-control" name="tipe">
                        <option value="main">MauMasak Official</option>
                        <option value="store">MauMakan Official</option>
                      </select>
                    </div>
                  </div>
