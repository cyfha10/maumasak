      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <!--  -->
            <form action="<?php echo base_url('admin/updaterecipes/') ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="bs-stepper-content">
                    ...
                    <div id="addresep-part" class="content" role="tabpanel" aria-labelledby="addresep-part-trigger">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="recipe_id" value="<?php echo $recipes->recipe_id; ?>">
                      </div>
                      <div class="form-group">
                        ...
                        <select name="cuisine" id="cuisine" class="form-control" required>
                          ...
                          if($datacuisine){
                            foreach($datacuisine as $cuisine){
                              ?>
                              <option <?php echo $recipes->cuisine_id==$cuisine['cuisine_id']?'selected':'' ?> value="<?php echo $cuisine['cuisine_id'];?>"><?php echo $cuisine['cuisine_name']; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="kategori" id="kategori" class="form-control" required>
                          ...
                          if($datacategory){
                            foreach($datacategory as $kategori){
                              ?>
                              <option <?php echo $recipes->category_id==$kategori['category_id']?'selected':'' ?> value="<?php echo $kategori['category_id'];?>"><?php echo $kategori['category_name']; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="setmenu" id="setmenu" class="form-control">
                          ...
                          if($datasetmenu){
                            foreach($datasetmenu as $setmenu){
                              ?>
                              <option <?php echo $recipes->set_menu_id==$setmenu['set_menu_id']?'selected':'' ?> value="<?php echo $setmenu['set_menu_id'];?>"><?php echo $setmenu['set_menu']; ?></option>
                              <?php
                            }
                          }
                          ?>
                    ...
                    <div id="porsi-part" class="content" role="tabpanel" aria-labelledby="porsi-part-trigger">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <input type="number" value="<?php echo $recipes->inactive_time ?>" name="waktupersiapanbumbu" min="1" max="60" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                          </div>
                        </div>
                      </div>
