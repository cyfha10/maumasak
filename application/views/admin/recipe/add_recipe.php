      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <form action="<?php echo base_url('admin/actrecipes') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="bs-stepper-content">
                  ...
                  <div id="addresep-part" class="content" role="tabpanel" aria-labelledby="addresep-part-trigger">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_resep" class="form-control" id="nama" placeholder="Masukkan Nama Recipe" maxlength="50" required>
                    </div>

                    <div class="form-group">
                      <label for="nama">Deskripsi</label>
                      <textarea class="form-control" id="exampleFormControlTextarea1" name="deskripsiresep" rows="8" maxlength="4000"></textarea>
                    </div>
                  ...
                  <div id="porsi-part" class="content" role="tabpanel" aria-labelledby="porsi-part-trigger">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="number" name="waktupersiapanbahan" min="1" max="60" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="number" name="waktupersiapanbumbu" min="1" max="60" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <input type="number" name="waktupersiapanmasak" min="1" max="60" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Dalam Menit....">
                        </div>
                      </div>
                    </div>
