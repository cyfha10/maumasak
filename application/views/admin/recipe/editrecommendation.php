  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Resep Rekomendasi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
              <li class="breadcrumb-item active">Edit Resep Rekomendasi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-custom">
              <div class="card-header">
                <h3 class="card-title">Edit Resep Rekomendasi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php $recipe_id = $this->uri->segment(3); ?>
              <?php $id_rekomen = $this->uri->segment(4); ?>
              <form action="<?php echo base_url('admin/update_rekomen/'.$recipe_id.'/'.$id_rekomen); ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <a href="<?php echo base_url('admin/choose_recipe/'.$recipe_id.'/'.$id_rekomen) ?>">
