        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-custom">
              ...
              <form action="<?php echo base_url('admin/updatecategory/'.$id); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="emailaddress">Kategori</label>
                    <input type="text" name="category_name" class="form-control" id="emailaddress" placeholder="Masukkan Nama Role" value="<?php echo $row->category_name ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="files">File input</label><br>
                    <img src="https://filestocks.maumasak.id/category/<?php echo $row->category_image; ?>" width = "10%">
